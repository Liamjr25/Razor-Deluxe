<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="AddVehicle.aspx.cs" Inherits="RazorDeluxe.AddVehicle" %>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="mynavbar">
      ...
      <form class="d-flex">
        ...
        <tr>
            <td>
                <asp:TextBox CssClass="txtbox" ID="txtID" runat="server" placeholder="Enter Id" type="search"></asp:TextBox>
            ...
            <td>
                <asp:TextBox CssClass="txtbox" ID="txtBrandCompany" runat="server" placeholder="Enter Company Brand" type="search"></asp:TextBox>
            ...
            <td>
                <asp:TextBox CssClass="txtbox" ID="txtModel" runat="server" placeholder="Enter Model" type="search"></asp:TextBox>
        ...
        <tr>
            <td>
                <asp:TextBox CssClass="txtbox" ID="txtYear" runat="server" placeholder="Enter Year" type="search"></asp:TextBox>
            ...
            <td>
                <asp:TextBox CssClass="txtbox" ID="txtTransmission" runat="server" placeholder="Enter Transmission" type="search"></asp:TextBox>
            ...
            <td>
                <asp:TextBox CssClass="txtbox" ID="txtFuelType" runat="server" placeholder="Enter FuelType" type="search"></asp:TextBox>
        ...
        <tr>
            <td>
                <asp:TextBox CssClass="txtbox" ID="txtPower" runat="server" placeholder="Enter Power" type="search"></asp:TextBox>
            ...
            <td>
                <asp:TextBox CssClass="txtbox" ID="txtEngineSize" runat="server" placeholder="Enter Engine Size" type="search"></asp:TextBox>
            ...
            <td>
                <asp:TextBox CssClass="txtbox" ID="txtStandardFeatures" runat="server" placeholder="Enter Standard Features" type="search"></asp:TextBox>
        ...
        <tr>
            <td>
                <asp:TextBox CssClass="txtbox" ID="txtTopspeed" runat="server" placeholder="Enter Topspeed" type="search"></asp:TextBox>
            ...
            <td>
                <asp:TextBox CssClass="txtbox" ID="txtDescription" runat="server" placeholder="Description" type="search" TextMode="MultiLine"></asp:TextBox>
            ...
            <td>
                <asp:TextBox CssClass="txtbox" ID="txtImages" runat="server" placeholder="Enter Images" type="search" Visible="False"></asp:TextBox>
        ...
        <tr>
            <td class="auto-style3">
                <asp:TextBox CssClass="txtbox" ID="txtnewCarsCode" runat="server" placeholder="Enter Cars Code" type="search"></asp:TextBox>
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="txtnewCarsCode" ErrorMessage="Please Enter!*" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            <td class="auto-style3">
                <asp:TextBox CssClass="txtbox" ID="txtSeats" runat="server" placeholder="Enter no. of Seats" type="search"></asp:TextBox>
            ...
            <td class="auto-style3">
                <asp:TextBox CssClass="txtbox" ID="txtFuelConsumption" runat="server" placeholder="Enter Consumption" type="search"></asp:TextBox>
   ...
   <tr>
            <td>&nbsp;</td>
            <td>
                <asp:Button class="button" ID="btnAdd" runat="server" Text="Add" OnClick="btnAdd_Click" />
            </td>
            <td>&nbsp;</td>
        </tr>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [Vehicles] WHERE [Id] = @Id" InsertCommand="INSERT INTO Vehicles(Id, BrandCompany, [Model ], Year, Transmission, FuelType, Power, EngineSize, StandardFeatures, Topspeed, Description, Images, CarsCode, Seats, FuelConsumption) VALUES (@Id, @BrandCompany, @Model_, @Year, @Transmission, @FuelType, @Power, @EngineSize, @StandardFeatures, @Topspeed, @Description, @Images, @CarsCode, @Seats, @FuelConsumption)" SelectCommand="SELECT [Id], [BrandCompany], [Model ] AS Model_, [Year], [Transmission], [FuelType], [Power], [EngineSize], [StandardFeatures], [Topspeed], [Description], [Images], [CarsCode], [Seats], [FuelConsumption] FROM [Vehicles]" UpdateCommand="UPDATE [Vehicles] SET [BrandCompany] = @BrandCompany, [Model ] = @Model_, [Year] = @Year, [Transmission] = @Transmission, [FuelType] = @FuelType, [Power] = @Power, [EngineSize] = @EngineSize, [StandardFeatures] = @StandardFeatures, [Topspeed] = @Topspeed, [Description] = @Description, [Images] = @Images, [CarsCode] = @CarsCode, [Seats] = @Seats, [FuelConsumption] = @FuelConsumption WHERE [Id] = @Id">
        ...
        <InsertParameters>
            ...
            <asp:controlParameter ControlID="txtnewCarsCode" Name="CarsCode" Type="String" />
