<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="DeleteByModel.aspx.cs" Inherits="RazorDeluxe.DeleteByModel" %>
...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
  <div class="container-fluid">
    ...
    <table style="width:100%;">
        ...
        <tr>
            <td>
              <asp:Label ID="lblDelete" runat="server" Text="Model:"></asp:Label>
                </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td>
                <asp:TextBox CssClass="txtbox" ID="txtModel" runat="server" placeholder="What are you looking for?" type="search"></asp:TextBox>  <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ControlToValidate="txtModel" ErrorMessage="Please Enter!*" ForeColor="Red"></asp:RequiredFieldValidator>    
