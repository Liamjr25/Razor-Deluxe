<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SearchByBrand.aspx.cs" Inherits="RazorDeluxe.SearchByBrand" %>
...
@keyframes glow {
    ...
    <table style="width:100%;">
        ...
        <tr>
            <td class="auto-style1">Welcome To Search By Company Brand</td>
            <td class="auto-style1"></td>
            <td class="auto-style1"></td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <asp:TextBox CssClass="txtbox" ID="txtBrand" runat="server" placeholder="Enter Company  Brand" type="search"></asp:TextBox>  <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ControlToValidate="txtBrand" ErrorMessage="Please Enter!*" ForeColor="Red"></asp:RequiredFieldValidator>    
        ...
        <tr>
            <td>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Id], [BrandCompany], [Model ] AS Model_, [Year], [Transmission], [FuelType], [Power], [EngineSize], [StandardFeatures], [Topspeed], [Description], [Images], [CarsCode], [Seats], [FuelConsumption] FROM [Vehicles] WHERE ([BrandCompany] = @BrandCompany)">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="txtBrand" Name="BrandCompany" PropertyName="Text" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </td>
            <td>&nbsp;</td>
