<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="AddNewAdmin.aspx.cs" Inherits="RazorDeluxe.AddNewAdmin" %>
    ...
    <table style="width:100%;">
        ...
        <tr>
            <td>
                ...
                <asp:TextBox CssClass="txtbox" ID="txtID" runat="server" type="search"></asp:TextBox>  <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ControlToValidate="txtID" ErrorMessage="Please Enter!*" ForeColor="Red"></asp:RequiredFieldValidator>    
                </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <asp:TextBox CssClass="txtbox" ID="txtUsername" runat="server" placeholder="Enter Username" type="search"></asp:TextBox>  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtUsername" ErrorMessage="Please Enter!*" ForeColor="Red"></asp:RequiredFieldValidator>    
                </td>
            
            <td>
                <asp:Label ID="lblPassword" runat="server" Text="Password"></asp:Label>
                <asp:TextBox CssClass="txtbox" ID="txtPassword" runat="server" placeholder="Enter Password?" type="search"></asp:TextBox>  <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtPassword" ErrorMessage="Please Enter!*" ForeColor="Red"></asp:RequiredFieldValidator>    
                </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <asp:TextBox CssClass="txtbox" ID="txtFirstName" runat="server" placeholder="Enter Firstname" type="search"></asp:TextBox>  <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtFirstName" ErrorMessage="Please Enter!*" ForeColor="Red"></asp:RequiredFieldValidator>    
                <asp:Button class="button" ID="btnAdd" runat="server" Text="Add" OnClick="btnAdd_Click" />
            </td>
            <td>
                <asp:Label ID="lblLastname" runat="server" Text="Lastname"></asp:Label>
                <asp:TextBox CssClass="txtbox" ID="txtLastname" runat="server" placeholder="Enter Lastname" type="search" OnTextChanged="txtLastname_TextChanged"></asp:TextBox>  <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtLastName" ErrorMessage="Please Enter!*" ForeColor="Red"></asp:RequiredFieldValidator>    
                </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
