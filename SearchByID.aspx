<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SearchByID.aspx.cs" Inherits="RazorDeluxe.SearchByID" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> <head><style>
...
@keyframes glow {
    ...
    <table style="width:100%;">
        ...
        <tr>
            <td>Welcome To Search for a Car By ID</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <asp:TextBox CssClass="txtbox" ID="txtID" runat="server" placeholder="Enter Brand ID" type="search"></asp:TextBox>  <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ControlToValidate="txtID" ErrorMessage="Please Enter!*" ForeColor="Red"></asp:RequiredFieldValidator>    
        ...
        <tr>
            <td>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Id], [BrandCompany], [Model ] AS Model_, [Year], [Transmission], [FuelType], [Power], [EngineSize], [StandardFeatures], [Topspeed], [Description], [Images], [CarsCode], [Seats], [FuelConsumption] FROM [Vehicles] WHERE ([Id] = @Id)">
                    <SelectParameters>
